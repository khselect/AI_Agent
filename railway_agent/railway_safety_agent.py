...
@tool
def extract_pdf_tool(pdf_path: str, model_name: str = "qwen3:30b-a3b") -> str:
    """
    [Tool ①] PDF 사고조사보고서에서 43개 표준 필드를 자동 추출합니다.

    Args:
        pdf_path  : 로컬 PDF 파일 경로 (절대경로 권장)
        model_name: Ollama 모델명 (기본: qwen3:30b-a3b)
...
def build_agent(model_name: str = "qwen3:30b-a3b"):
    """
...
def run_agent(goal: str, model_name: str = "qwen3:30b-a3b") -> str:
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, default="qwen3:30b-a3b", help="Ollama 모델명")
